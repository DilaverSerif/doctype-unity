...
namespace Doctype.EditorTools
{
    ...
    ///         -executeMethod Doctype.EditorTools.HtmlBenchmarkSceneBuilder.Build -quit
    /// </remarks>
    public static class HtmlBenchmarkSceneBuilder
    {
        public const string ScenePath = "Assets/Doctype/Samples/HtmlBenchmark.unity";

        [MenuItem("Tools/Doctype/Build Benchmark Scene")]
        public static void Build()
        {
            ...
            Debug.Log($"[Doctype] benchmark scene written to {ScenePath}");
        }

        static void CreateLoad()
        {
            var root = new GameObject("Load", typeof(HtmlBenchmarkLoad));
        ...
        static void CreateUi()
        {
            ...
            hudGo.AddComponent<HtmlBenchmark>();
        }
