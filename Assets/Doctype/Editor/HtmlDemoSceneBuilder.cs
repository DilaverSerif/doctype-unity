...
namespace Doctype.EditorTools
{
    ...
    ///         -executeMethod Doctype.EditorTools.HtmlDemoSceneBuilder.Build -quit
    /// </remarks>
    public static class HtmlDemoSceneBuilder
    {
        public const string ScenePath = "Assets/Doctype/Samples/HtmlDemo.unity";

        [MenuItem("Tools/Doctype/Build Demo Scene")]
        public static void Build()
        {
            ...
            Debug.Log($"[Doctype] demo scene written to {ScenePath} (view: {view.name})");
        }
        ...
        private static GameObject CreateUi()
        {
            ...
            var panelGo = new GameObject("HtmlPanel", typeof(RectTransform), typeof(RawImage));
            ...
            panelGo.AddComponent<HtmlView>();
            panelGo.AddComponent<HtmlRawImage>();
            ...
            panelGo.AddComponent<HtmlDemoController>();
