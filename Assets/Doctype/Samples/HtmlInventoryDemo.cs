...
namespace Doctype.Samples
{
    ...
    /// HtmlViews with their own RectTransforms, and dragging an item from
    ...
    /// on, so the hotbar never hears the drop on its own; <c>HtmlDrag.View</c>
    ...
    /// </para>
    /// </remarks>
    [AddComponentMenu("Doctype/Samples/Inventory Demo")]
    public class HtmlInventoryDemo : MonoBehaviour
    {
        ...
        [SerializeField] private HtmlView _bagView;
        [SerializeField] private HtmlView _hotbarView;

        /// <summary>The bag's surface. Assigned by the scene builder.</summary>
        public HtmlView BagView { get => _bagView; set => _bagView = value; }

        /// <summary>The hotbar's surface. Assigned by the scene builder.</summary>
        public HtmlView HotbarView { get => _hotbarView; set => _hotbarView = value; }
        ...
        HtmlRawImage _bagRaw;
        HtmlRawImage _hotRaw;
        HtmlResources _resources;

        RawImage _ghost;
        RectTransform _ghostRect;
        Canvas _canvas;
        HtmlDemoWorld _world;
        ...
        HtmlView _hoveredView;   // and the page that owns it
        ...
        void Awake()
        {
            ...
            _bagRaw = _bagView != null ? _bagView.GetComponent<HtmlRawImage>() : null;
            _hotRaw = _hotbarView != null ? _hotbarView.GetComponent<HtmlRawImage>() : null;
        ...
        void BuildIcons()
        {
            ...
            _resources.Register("coin", HtmlDemoIcons.Coin(96));
            _resources.Register("gem", HtmlDemoIcons.Gem(96));
            _resources.Register("potion", HtmlDemoIcons.Potion(96));
        }
        ...
        void CreateWorld()
        {
            ...
            _world = HtmlDemoWorld.Create(_canvas);
            _world.Tapped += OnWorldTapped;
        }
...
";
  ...
  #status { color:#7f8aa8; font-size:2.4vw; margin:0 0 1.8vw 0; }
        ...
        bool BeginItemDrag(HtmlDrag drag)
        {
        ...
        void OnDragMoved(HtmlDrag drag)
        {
            MoveGhost(drag.ScreenPosition);
            Highlight(drag.View, drag.ElementId);
        }

        void OnDropped(HtmlDrag drag)
        {
        ...
        /// </summary>
        void SizeGhostTo(HtmlView source)
        {
        ...
        /// a border colour.
        /// </summary>
        void Highlight(HtmlView view, string id)
        {
            if (id == _hovered)
            {
                return;
