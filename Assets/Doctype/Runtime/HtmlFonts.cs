...
namespace Doctype
{
    ...
    /// </remarks>
    public static class HtmlSystemFonts
    {
        ...
        /// </summary>
        public static List<HtmlFontEntry> Discover()
        {
            var result = new List<HtmlFontEntry>();
            ...
            {
                result.Add(new HtmlFontEntry { Family = family, Weight = 400, AbsolutePath = regularPath });
            }
            ...
            if (boldPath != null)
            {
                foreach (string family in new[] { "sans-serif", "serif", "system-ui", "arial", "helvetica" })
                {
                    result.Add(new HtmlFontEntry { Family = family, Weight = 700, AbsolutePath = boldPath });
                }
            }
            ...
            if (monoPath != null)
            {
                ...
                {
                    result.Add(new HtmlFontEntry { Family = family, Weight = 400, AbsolutePath = monoPath });
                }
            }
