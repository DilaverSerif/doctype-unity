...
{
    /// <summary>
    /// Covers <see cref="HtmlDocument.SetText"/>, the path that updates a
    ...
    public class HtmlSetTextTests
    {
        ...
        /// </summary>
        static List<(float x, float y, float w, float h, int type)> Snapshot(HtmlDocument doc,
                                                                             out float height,
                                                                             out int glyphs)
        {
        ...
        static HtmlDocument Load(string html)
        {
        ...
        {
            using HtmlDocument mutated = Load(Page);
            ...
            using HtmlDocument reparsed = Load(Page.Replace(">AB<", ">ABCD<"));
        ...
        public void SetTextRemeasuresWithExactAhemMetrics()
        {
            ...
            using HtmlDocument doc = Load(Page);
