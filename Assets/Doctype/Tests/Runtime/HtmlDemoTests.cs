...
namespace Doctype.Tests
{
    ...
    /// </remarks>
    public class HtmlDemoTests
    {
        private GameObject _root;
        private HtmlView _view;
        private HtmlDemoController _demo;
        ...
        public void SetUp()
        {
            ...
            _view = panel.AddComponent<HtmlView>();
            panel.AddComponent<HtmlRawImage>();
            _limiter = panel.AddComponent<FrameRateLimiter>();
            _demo = panel.AddComponent<HtmlDemoController>();
        }
        ...
        {
            yield return Settle();
            Assert.AreEqual(HtmlDemoController.Page.Overview, _demo.CurrentPage, "starts on Overview");
            ...
            _demo.GoTo(HtmlDemoController.Page.Typography);
            yield return Settle(8);

            Assert.AreEqual(HtmlDemoController.Page.Typography, _demo.CurrentPage);
        ...
        public IEnumerator ClickingANavLinkNavigates()
        {
            ...
            Assert.AreNotEqual(HtmlDemoController.Page.Overview, _demo.CurrentPage,
        ...
        {
            _demo.GoTo(HtmlDemoController.Page.Animation);
            _demo.Animate = true;
        ...
        {
            _demo.GoTo(HtmlDemoController.Page.Performance);
            yield return Settle(10);
        ...
        public IEnumerator ClickingADemoButtonReachesCSharp()
        {
            ...
            _demo.GoTo(HtmlDemoController.Page.Overview);
            yield return Settle(10);
        ...
        public IEnumerator RebuildCostStaysWithinAFrameBudget()
        {
            ...
            Debug.Log($"[Doctype] animated rebuild: mean {mean:0.00} ms, worst {worst:0.00} ms, " +
