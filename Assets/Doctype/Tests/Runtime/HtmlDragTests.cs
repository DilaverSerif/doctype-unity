...
namespace Doctype.Tests
{
    ...
    public class HtmlDragTests
    {
        ...
        public void SetUp()
        {
            ...
            _view = go.GetComponent<HtmlView>();
            _raw = go.GetComponent<HtmlRawImage>();
        ...
        public IEnumerator ResourcesSetBeforeInitialiseSurvive()
        {
            ...
            go.SetActive(false);
            HtmlView view = go.AddComponent<HtmlView>();

            var provider = new GameObject("Res").AddComponent<HtmlResources>();
