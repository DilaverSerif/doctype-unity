...
namespace LiteHtmlUnity.Samples
{
    ...
    /// </remarks>
    [AddComponentMenu("LiteHtml/Samples/LiteHtml Demo World")]
    public class LiteHtmlDemoWorld : MonoBehaviour, IPointerClickHandler
    {
        ...
        /// </summary>
        public static LiteHtmlDemoWorld Create(Canvas canvas)
        {
            var go = new GameObject("World", typeof(RectTransform), typeof(RawImage), typeof(LiteHtmlDemoWorld));
            ...
            var world = go.GetComponent<LiteHtmlDemoWorld>();
            world.BuildRings();
            return world;
        }
