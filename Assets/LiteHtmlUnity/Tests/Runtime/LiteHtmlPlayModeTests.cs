...
namespace LiteHtmlUnity.Tests
{
    ...
    /// </summary>
    /// <remarks>
    /// EditMode tests drive <see cref="LiteHtmlDocument"/> and
    /// <see cref="LiteHtmlRenderer"/> directly. These instead go through
    /// <see cref="LiteHtmlView"/>'s MonoBehaviour lifecycle — OnEnable, the
    /// LateUpdate render loop, target recreation, teardown on destroy — which is
    /// where lifetime and per-frame bugs live.
    /// </remarks>
    public class LiteHtmlPlayModeTests
    {
        ...
        public void SetUp()
        {
            _go = new GameObject("LiteHtmlView");
            _view = _go.AddComponent<LiteHtmlView>();
        }
        ...
        public IEnumerator DemoSceneRunsAndKeepsRebuilding()
        {
            ...
            // LiteHtmlRawImage + LiteHtmlView + the demo controller.
            Object.DestroyImmediate(_go);
            _go = null;
